...
secret = 'H' # We don't know the original message or length
...
def step2(s): return b64encode(s.encode('utf8'))
...
def make_secret(plainf, count):
	plain = plainf.encode('utf-8')
...
if __name__ == '__main__':
	print (make_secret(secret, count=123)) 
